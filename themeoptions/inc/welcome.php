        ...
        <?php $this->tabs (); ?>
            ...
            <div class="changelog">
                ...
                <div class="feature-section">
                    ...
                    <p><?php
                         $msg = 'We do our best to provide the best support we can. If you encounter a problem or have a question, post a question in the <a href=easy_digital_download/support">support forums</a>.';
                         _e ( $msg , 'pixel-linear' );
                          ?></p>
